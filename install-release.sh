...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/sjtuross/v2ray-sspanel-v3-mod_Uim-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/sjtuross/v2ray-sspanel-v3-mod_Uim-plugin/releases/latest"
